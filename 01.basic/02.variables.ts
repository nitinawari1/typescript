...
//string
 let Mystring : string = "nitin awari" 
Mystring.toLowerCase() //string method 


//number 
let Mynum : number = 33.523;
...
//do not
let Hero; // here we not defining special type so it assign any type thats mwwans it can store any value 
